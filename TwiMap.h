...
#define TwiMap_h
    ...
    //------------------------------------------------------------------------------
#elif defined(ARDUINO_ARCH_ESP32) || defined(ARDUINO_XIAO_RA4M1) || defined(NRF52840_XXAA) || defined(ARDUINO_ARCH_RP2040) || defined(ARDUINO_ARCH_RP2350) || defined(SEEED_XIAO_M0)
    uint8_t const TWI_SDA_PIN = D6; 
    uint8_t const TWI_SCL_PIN = D7; 
#else  // AVR CPU
    #error unknown CPU
#endif  // AVR CPU
#endif  // TwiMap_h
